...
class Petugas extends BaseController
{
	...
	public function tambahPetugas()
	{
		...
		// $data['jml_masyarakat'] = null;
		// $data['jml_ptgs'] = null;
		// $data['jml_pengaduan'] = null;
	...
	public function simpanPetugas()
	{
		...
		session()->setFlashdata('msg', 'Data petugas Berhasil Ditambahkan');
	...
	public function updatePetugas()
	{
		...
		session()->setFlashdata('edt', 'Data Petugas Berhasil Diubah');
		return redirect()->to('/petugas/user');
	}
	public function hapusPetugas($idPetugas)
	{
		...
		session()->setFlashdata('dlt', 'Data petugas Berhasil Dihapus');
	...
	public function simpanMasyarakat()
	{
		...
		session()->setFlashdata('msg', 'Data Masyarakat Berhasil Ditambahkan');
	...
	public function updateMasyarakat()
	{
		...
		session()->setFlashdata('edt', 'Data Masyarakat Berhasil Diubah');
	...
	public function hapusMasyarakat($NIK)
	{
		...
		session()->setFlashdata('dlt', 'Data Masyarakat Berhasil Dihapus');
	...
	public function verifikasi()
	{
		...
		//tambahkan ini kesemua function jika terjadi eror
	...
	public function tanggapan($idpengaduan)
	{
		...
		session()->setFlashdata('vrf', 'Anda Berhasil Merespon Pengaduan Ini');
