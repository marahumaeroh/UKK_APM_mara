...
$routes->get('/tambah/pengaduan', 'Controllermasyarakat::pengaduan_masy', ['filter' => 'otentifikasimasyarakat']);
...
$routes->get('/petugas/dashboard', 'Dashboardpetugas::dashboard', ['filter' => 'otentifikasi']);
...
$routes->add('/laporan/tanggapan/pdf', 'LaporanController::tanggapan', ['filter' => 'otentifikasi']);
$routes->get('/laporan/pengaduan/pdf', 'LaporanController::pengaduan', ['filter' => 'otentifikasi']);

//pengaturan akun
$routes->get('/Akun', 'Controllermasyarakat::profile');
$routes->post('/update_pass', 'Controllermasyarakat::proses_edit_pass', ['as' => 'updatePass']);

//print
$routes->get('/print', 'Laporan::pengaduanTampil', ['filter' => 'otentifikasi']);
/*
 * --------------------------------------------------------------------
 * Additional Routing
 * --------------------------------------------------------------------
